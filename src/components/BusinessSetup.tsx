        ...
        <div className="text-center mb-8">
          ...
          <div className="mt-4">
            <button
              ...
              className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-lg text-xs font-semibold bg-white text-indigo-700 border border-indigo-200 hover:border-indigo-400 hover:bg-indigo-50/50 shadow-xs transition-colors"
            >
          ...
          <div className="pt-4 border-t border-slate-100 flex flex-col sm:flex-row items-center justify-between gap-3">
            {onCancel ? (
              <button
                ...
                id="btn-cancel-setup"
                onClick={onCancel}
                className="w-full sm:w-auto px-5 py-2.5 text-sm font-semibold text-slate-600 hover:text-slate-800 rounded-xl hover:bg-slate-100 transition-colors"
              >
                Cancel
              </button>
            ) : (
            ...
            <button
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3.5 text-sm font-bold text-white bg-indigo-600 hover:bg-indigo-700 active:bg-indigo-800 rounded-xl shadow-md shadow-indigo-200 transition-all hover:translate-x-0.5"
            >
