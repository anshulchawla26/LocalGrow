  ...
  return (
    <div className="space-y-8 pb-12">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pb-2 border-b border-slate-200/80">
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto">
          <button
            ...
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-4 py-2.5 text-xs sm:text-sm font-semibold text-white bg-indigo-600 hover:bg-indigo-700 active:bg-indigo-800 rounded-xl shadow-xs transition-colors min-h-[44px]"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 sm:gap-6 items-stretch">
        ...
        <div className="lg:col-span-7 bg-white rounded-2xl border border-slate-200/90 shadow-sm p-5 sm:p-7 flex flex-col justify-between relative overflow-hidden">
          ...
          <div>
            <div className="flex flex-wrap items-start justify-between gap-2 mb-4">
              ...
              {/* Tag indicator */}
              <span className="text-xs font-semibold px-2.5 py-1 rounded-full bg-slate-100 text-slate-700 border border-slate-200 self-start">
                {businessInfo.category}
              </span>
            </div>

            <div className="flex flex-col sm:flex-row items-center gap-5 sm:gap-6 my-4">
          ...
          <div className="pt-4 border-t border-slate-100 flex flex-col sm:flex-row sm:items-center justify-between text-xs text-slate-600 gap-2.5">
            <span className="flex items-center gap-1">
              <HelpCircle className="w-3.5 h-3.5 shrink-0 text-slate-400" />
              <span>An indicative score based on your provided information.</span>
            </span>
            <button
              id="btn-edit-business-profile-score"
              onClick={() => setActiveView("profile")}
              className="font-semibold text-indigo-600 hover:text-indigo-800 text-left sm:text-right min-h-[36px] flex items-center"
            >
              Update Profile →
            </button>
          </div>
        ...
        <div className="lg:col-span-5 bg-white rounded-2xl border border-slate-200/90 shadow-sm p-5 sm:p-7 flex flex-col justify-between">
          <div>
            <div className="flex flex-wrap items-center justify-between gap-2 mb-3">
              ...
              <span className="text-[10px] uppercase font-bold tracking-wider px-2 py-0.5 rounded-md bg-slate-100 text-slate-600 border border-slate-200 self-start">
            ...
            <div className="pt-3 pb-2">
              <div className="h-32 w-full flex items-end justify-between gap-2 sm:gap-3 px-2 py-1 bg-slate-50/70 rounded-xl border border-slate-100">
                {/* Week 1 */}
                <div className="flex-1 flex flex-col items-center gap-1.5 h-full justify-end">
                  <span className="text-[10px] font-semibold text-slate-500">
                    42%
                  </span>
                  <div className="w-full max-w-[34px] sm:max-w-[42px] bg-indigo-200 hover:bg-indigo-300 rounded-t-md h-[42%] transition-all"></div>
                ...
                <div className="flex-1 flex flex-col items-center gap-1.5 h-full justify-end">
                  ...
                  <div className="w-full max-w-[34px] sm:max-w-[42px] bg-indigo-300 hover:bg-indigo-400 rounded-t-md h-[55%] transition-all"></div>
                  <span className="text-[11px] font-medium text-slate-600">
                    Week 2
                  </span>
                </div>
                ...
                <div className="flex-1 flex flex-col items-center gap-1.5 h-full justify-end">
                  ...
                  <div className="w-full max-w-[34px] sm:max-w-[42px] bg-indigo-400 hover:bg-indigo-500 rounded-t-md h-[68%] transition-all"></div>
                  <span className="text-[11px] font-medium text-slate-600">
                    Week 3
                  </span>
                </div>
                ...
                <div className="flex-1 flex flex-col items-center gap-1.5 h-full justify-end">
                  ...
                  <div className="w-full max-w-[34px] sm:max-w-[42px] bg-indigo-600 rounded-t-md h-[82%] shadow-xs transition-all"></div>
      ...
      <div className="bg-gradient-to-r from-indigo-900 via-indigo-800 to-slate-900 rounded-2xl p-5 sm:p-6 text-white flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 shadow-md">
        ...
        <button
          ...
          onClick={() => setActiveView("tools")}
          className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl bg-white text-slate-900 font-bold text-xs sm:text-sm hover:bg-slate-100 active:bg-slate-200 transition-transform hover:scale-102 shrink-0 shadow-sm min-h-[44px]"
        >
